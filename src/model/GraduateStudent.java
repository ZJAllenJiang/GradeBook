...
public class GraduateStudent extends Student {
	...
	public GraduateStudent(String sid, String fName, String mName, String lName, boolean status) {
		super(sid, fName, mName, lName, status, StudentType.GRADUATE);
	}
	...
	public ArrayList<String> writeAsRecord() {
		...
		if (status)
			...
			res.add("Inactive");
		res.add(StudentType.GRADUATE.toString());
