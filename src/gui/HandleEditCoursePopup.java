...
public class HandleEditCoursePopup {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HandleEditCoursePopup window = new HandleEditCoursePopup();
	 ...
	 */
	public HandleEditCoursePopup(String str) {
		initialize(str);
	}
