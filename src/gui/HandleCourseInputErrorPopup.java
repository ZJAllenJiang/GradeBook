...
public class HandleCourseInputErrorPopup {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HandleCourseInputErrorPopup window = new HandleCourseInputErrorPopup();
	 ...
	 */
	public HandleCourseInputErrorPopup() {
		initialize();
	}
	 ...
	 */
	public HandleCourseInputErrorPopup(String str) {
		initialize(str);
	}
